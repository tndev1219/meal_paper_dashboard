...
function SalutariumsHeader(props)
{
         ...
         <div className="flex flex-shrink items-center sm:w-224">
            ...
            <div className="flex items-center">
               <FuseAnimate animation="transition.expandIn" delay={300}>
                  <Icon className="text-32 mr-12">hotel</Icon>
               </FuseAnimate>
               <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                  <Typography variant="h6" className="hidden sm:flex">療養所</Typography>
               </FuseAnimate>
            </div>
         </div>
               ...
               onClick={ev => {
                  if (agencies.length === 0) {
                     dispatch(showMessage({
                        message: '代理店は登録されていません。まず代理店を登録してください。',
...
export default SalutariumsHeader;
